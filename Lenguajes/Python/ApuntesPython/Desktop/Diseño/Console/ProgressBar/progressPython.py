'''
    Es un paquete desarrollado para usar barras de progreso, helices, contadores...
    en aplicaciones de consola.

    Normalmente se declaran antes del bucle y se usa el modulo Next() para avanzar

    Se puede usar la funcion sleep (del modulo time) para añadir un pequeño retardo
    de tiempo para que se pueda observar el progreso de los elementos usados
'''
...
caracteres = ['X', 'O']
datos = os.path.abspath(os.path.dirname(__file__))+"/datos.txt"
